...
!function (n) {
    ...
    var s = function (e, t) {
        this.id = ++Te.FE.ID;
        var n = {};
        t && t.documentReady && (n.toolbarButtons = ["fullscreen", "undo", "redo", "print", "|", "bold", "italic", "underline", "color", "clearFormatting", "|", "alignLeft", "alignCenter", "alignRight", "alignJustify", "|", "formatOL", "formatUL", "indent", "outdent", "-", "paragraphFormat", "|", "fontFamily", "|", "fontSize", "|", "insertLink", "insertImage", "quote"], n.paragraphFormatSelection = !0, n.fontFamilySelection = !0, n.fontSizeSelection = !0, n.placeholderText = null, n.quickInsertEnabled = !1, n.charCounterCount = !1), this.opts = Te.extend(!0, {}, Te.extend({}, s.DEFAULTS, n, "object" == typeof t && t));
    ...
    s.DEFAULTS = {
        ...
        if ("string" == typeof i) {
            ...
            return this.each(function () {
                var e = Te(this).data("froala.editor");
                if (e) {
                    var t, n;
                    if (0 < i.indexOf(".") && e[i.split(".")[0]] ? (e[i.split(".")[0]] && (t = e[i.split(".")[0]]), n = i.split(".")[1]) : (t = e, n = i.split(".")[0]), !t[n]) return Te.error("Method " + i + " does not exist in Froala Editor.");
    ...
    Te.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", Te.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", Te.FE.LinkRegExTLD = "((" + Te.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", Te.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + Te.FE.LinkRegExCommon + ")", Te.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + Te.FE.LinkRegExCommon + ")", Te.FE.LinkRegExWWW = "(www\\." + Te.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", Te.FE.LinkRegEx = "(" + Te.FE.LinkRegExTLD + "|" + Te.FE.LinkRegExHTTP + "|" + Te.FE.LinkRegExWWW + "|" + Te.FE.LinkRegExAuth + ")" + Te.FE.LinkRegExEnd, Te.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Te.FE.MAIL_REGEX = /.+@.+\..+/i, Te.FE.MODULES.helpers = function (a) {
        ...
        function R() {
            ...
            for (e = 0; e < t.length; e++) {
                var r = Te(t[e]).data("id"), i = t[e], a = T.doc.createRange(),
                ...
                if (0 < o.length) {
                    ...
                    try {
                        ...
                        if (i.nextSibling == o || o.nextSibling == i) {
                            ...
                            if (m && m.nodeType == Node.TEXT_NODE) for (; m && m.previousSibling && m.previousSibling.nodeType == Node.TEXT_NODE;) m.previousSibling.textContent = m.previousSibling.textContent + m.textContent, m = m.previousSibling, Te(m.nextSibling).remove();
                            for (var v = g.nextSibling; v && v.nodeType == Node.TEXT_NODE && 0 === v.length;) v = (l = v).nextSibling, Te(l).remove();
                            if (v && v.nodeType == Node.TEXT_NODE) for (; v && v.nextSibling && v.nextSibling.nodeType == Node.TEXT_NODE;) v.nextSibling.textContent = v.textContent + v.nextSibling.textContent, v = v.nextSibling, Te(v.previousSibling).remove();
        ...
        return {
            text: s, get: A, ranges: c, clear: C, element: function () {
                ...
                for (t = 0; t < i.length; t++) for (var a = i[t]; !(n(a) || T.node.isBlock(a.parentNode) || T.$el.is(a.parentNode) || T.node.hasClass(a.parentNode, "fr-inner"));) Te(a.parentNode).before(a);
                ...
                if (function () {
                    for (var e = T.$el.find(".fr-marker"), t = 0; t < e.length; t++) if (Te(e[t]).parentsUntil('.fr-element, [contenteditable="true"]', '[contenteditable="false"]').length) return !1;
                    return !0
                }()) {
                    !function e(t, n) {
                    ...
                    if (l.length) T.$el.find(".fr-marker").remove(), l.append(Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS).removeAttr("data-first"), l.attr("data-text") && l.replaceWith(l.html()); else for (T.$el.find("table").filter(function () {
        ...
        function c(e, t, n) {
            ...
            var a = function (e, t, n) {
                if (p.opts.fullPage) {
                    var r = p.html.extractDoctype(n), i = l(p.html.extractNodeAttrs(n, "html"));
        ...
        function f(e) {
            ...
            !function (e) {
                ...
                if (e.nodeType == Node.ELEMENT_NODE && Te.FE.HTML5Map[e.tagName] && "" === p.node.attributes(e)) {
                    var r = Te.FE.HTML5Map[e.tagName], i = "<" + r + ">" + e.innerHTML + "</" + r + ">";
                    e.insertAdjacentHTML("beforebegin", i), (e = e.previousSibling).parentNode.removeChild(e.nextSibling)
                }
                if (p.opts.htmlAllowComments || e.nodeType != Node.COMMENT_NODE) if (e.tagName && e.tagName.match(h)) e.parentNode.removeChild(e); else if (e.tagName && !e.tagName.match(u)) {
                    if ("svg" === e.tagName) e.parentNode.removeChild(e); else if (!p.browser.safari || "path" != e.tagName || !e.parentNode || "svg" != e.parentNode.tagName) try {
                    ...
                    if (a) for (var o = a.length - 1; 0 <= o; o--) {
                        var s = a[o], l = s.nodeName && s.nodeName.trim(), d = l.match(g), c = null;
        ...
        return {
            _init: function () {
                ...
                !function () {
                    ...
                    do {
                        if (t.length) {
                            var n = t[0], r = p.doc.createElement("ul");
                    ...
                    for (var e = p.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = p.node.contents(e[t]), r = null, i = n.length - 1; 0 <= i; i--) "LI" != n[i].tagName && "UL" != n[i].tagName && "OL" != n[i].tagName ? (r || (r = Te("<li>")).insertBefore(n[i]), r.prepend(n[i])) : r = null
                }(), function () {
                    var e, t, n;
                    do {
                        t = !1;
                    ...
                    for (var e = p.el.querySelectorAll("li > ul, li > ol"), t = 0; t < e.length; t++) {
                        var n = e[t];
                        if (p.node.isFirstSibling(n)) Te(n).before("<br/>"); else if (n.previousSibling && "BR" == n.previousSibling.tagName) {
        ...
        function l(e, t) {
            if (void 0 !== e && e || (e = d.el), void 0 === t && (t = !1), !e.getAttribute || "false" != e.getAttribute("contenteditable")) if (e.nodeType == Node.TEXT_NODE) r(e, t); else if (e.nodeType == Node.ELEMENT_NODE) for (var n = d.doc.createTreeWalker(e, NodeFilter.SHOW_TEXT, d.node.filter(function (e) {
        ...
        return {
            normalize: l, normalizeAroundCursor: function () {
        ...
        function a(e) {
            ...
            var l = p();
            for (l += "," + Te.FE.VOID_ELEMENTS.join(","), l += ", .fr-inner", l += "," + w.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),") + ":not(.fr-marker)", t = r.length - 1; 0 <= t; t--) if (!(r[t].textContent && 0 < r[t].textContent.replace(/\u200B|\n/g, "").length || 0 < r[t].querySelectorAll(l).length)) {
    ...
    }, Te.extend(Te.FE.DEFAULTS, {language: null}), Te.FE.LANGUAGE = {}, Te.FE.MODULES.language = function (e) {
        var t;
        return {
            _init: function () {
    ...
    }, Te.extend(Te.FE.DEFAULTS, {placeholderText: null}), Te.FE.MODULES.placeholder = function (f) {
        function e() {
            f.$placeholder || (f.$placeholder = Te('<span class="fr-placeholder"></span>'), f.$wp.append(f.$placeholder));
            var e, t = 0, n = 0, r = 0, i = 0, a = 0, o = 0, s = 0, l = f.node.contents(f.el),
        ...
        return {
            _init: function () {
                ...
                if (d.opts.iframe) {
                    ...
                    for (var t = Te('<style data-fr-style="true">' + e + "</style>").appendTo(d.$head)[0].sheet, n = 0; n < c.length; n++) for (var r = t.insertRule(c[n].selector + "{}", t.cssRules.length), i = 0; i < c[n].style.length; i++) {
        ...
        return {
            _startEnter: function (e) {
                var t, n = v(e), r = n.nextSibling, i = n.previousSibling, a = m.html.defaultTag();
                if (m.node.isEmpty(n, !0) && r) {
                    ...
                    var d = "";
                    for (d = l.parentNode && "LI" == l.parentNode.tagName ? s + "<li>" + Te.FE.MARKERS + "<br>" + o : a ? s + "<" + a + ">" + Te.FE.MARKERS + "<br></" + a + ">" + o : s + Te.FE.MARKERS + "<br>" + o; ["UL", "OL"].indexOf(l.tagName) < 0 || l.parentNode && "LI" === l.parentNode.tagName;) l = l.parentNode;
                ...
                for (var t = v(e), n = "", r = e, i = "", a = "", o = !1; r != t;) if (r = r.parentNode, !Te(r).is("span.fr-emoticon")) {
                ...
                for (var t = v(e), n = Te.FE.MARKERS, r = "", i = e, a = !1; i != t;) if (i = i.parentNode, !Te(i).is("span.fr-emoticon")) {
                ...
                if (r) {
                    ...
                    if (s == m.el) return !1;
                    if (s = s.nextSibling, m.node.isBlock(s)) Te.FE.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (Te(e).replaceWith(Te.FE.MARKERS), (t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Te(t[t.length - 1]).remove(), Te(n).append(Te(s).html()), Te(s).remove()); else for ((t = m.node.contents(n)).length && "BR" == t[t.length - 1].tagName && Te(t[t.length - 1]).remove(), Te(e).replaceWith(Te.FE.MARKERS); s && !m.node.isBlock(s) && "BR" != s.tagName;) Te(n).append(Te(s)), s = s.nextSibling
                }
            }
        }
        ...
        function c(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType == Node.TEXT_NODE) {
                    ...
                    } else Te(n.parentNode).after(Te.FE.MARKERS), Te(n.parentNode).remove(); else Te(n).after(Te.FE.MARKERS)
            ...
            } else if (Te.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove(); else if (u.node.isEmpty(n) && !u.node.isList(n)) Te(n).remove(), Te(e).replaceWith(Te.FE.MARKERS); else {
        ...
        function l(e) {
            var t = 0 < Te(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t);
            ...
            if (null !== n) {
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && a && Te.FE.NO_DELETE_TAGS.indexOf(a.tagName) < 0) if (u.node.isDeletable(a) || !u.node.isEditable(a)) Te(a).remove(), Te(e).replaceWith(Te.FE.MARKERS); else if (u.node.isBlock(a) && u.node.isEditable(a)) if (u.node.isList(a)) if (u.node.isEmpty(n, !0)) Te(n).remove(), Te(a).find("li:first").prepend(Te.FE.MARKERS); else {
                    ...
                    if ((i = u.node.contents(a)).length && "BR" == i[0].tagName && Te(i[0]).remove(), "BLOCKQUOTE" != a.tagName && "BLOCKQUOTE" == n.tagName) for (i = u.node.contents(n); i.length && u.node.isBlock(i[i.length - 1]);) n = i[i.length - 1], i = u.node.contents(n); else if ("BLOCKQUOTE" == a.tagName && "BLOCKQUOTE" != n.tagName) for (i = u.node.contents(a); i.length && u.node.isBlock(i[0]);) a = i[0], i = u.node.contents(a);
        ...
        function n(e) {
            ...
            if ("BR" == (n = n.nextSibling).tagName && u.node.isEditable(n)) if (n.nextSibling) {
                ...
                if (s(e)) u.cursorLists._del(e); else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && Te.FE.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && Te(n).remove(), l(e));
                return
            }
            ...
            } else if (Te.FE.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n))) if (u.node.isDeletable(n)) Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove(); else if (u.node.isList(n)) e.previousSibling ? (Te(n).find("li:first").prepend(e), u.cursorLists._backspace(e)) : (Te(n).find("li:first").prepend(Te.FE.MARKERS), Te(e).remove()); else if ((t = u.node.contents(n)) && t.length && "BR" == t[0].tagName && Te(t[0]).remove(), t && "BLOCKQUOTE" == n.tagName) {
                var r = t[0];
            ...
            } else Te(e).after(Te(n).html()).after(Te.FE.MARKERS), Te(n).remove(); else u.node.isEditable(n) || (Te(e).replaceWith(Te.FE.MARKERS), Te(n).remove())
        }
        ...
        function p(e, t, n) {
            ...
            if (null == i) (r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? Te(e).replaceWith("<" + r + ">" + Te.FE.MARKERS + "<br></" + r + ">") : !e.previousSibling || Te(e.previousSibling).is("br") || e.nextSibling ? Te(e).replaceWith("<br>" + Te.FE.MARKERS) : Te(e).replaceWith("<br>" + Te.FE.MARKERS + "<br>"); else {
                var a = e, o = "";
        ...
        function m(e, t, n) {
            ...
            if (null == r) u.html.defaultTag() && e.parentNode === u.el ? Te(e).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">") : (e.nextSibling && !u.node.isBlock(e.nextSibling) || Te(e).after("<br>"), Te(e).replaceWith("<br>" + Te.FE.MARKERS)); else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) Te(e).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">"); else {
                var i = e, a = "";
                "PRE" == r.tagName && (t = !0), u.node.isBlock(r) && !t || (a = "<br>");
                var o = "", s = "";
                do {
                    var l = i;
                    if (i = i.parentNode, "BLOCKQUOTE" == r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && 0 < Te(l).find(e).length && Te(l).after(e), "BLOCKQUOTE" != r.tagName || !g(e, i) && !h(e, i)) if (!t || i != r || t && !u.node.isBlock(r)) {
                ...
                if ("BLOCKQUOTE" == r.tagName) if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" == e.nextSibling.tagName && (Te(e.nextSibling).after(e), e.nextSibling && "BR" == e.nextSibling.tagName && Te(e.nextSibling).remove()), t) a = o + a + Te.FE.MARKERS + s; else {
        ...
        return {
            enter: function (t) {
                ...
                0 < Te(n).parentsUntil(u.$el, "BLOCKQUOTE").length && (i = !0), Te(n).parentsUntil(u.$el, "TD, TH").length && (i = !1), a(n) ? !s(n) || t || i || 0 !== Te(n).parentsUntil("LI", ".fr-img-caption").length ? p(n, t, i) : u.cursorLists._endEnter(n) : o(n) ? !s(n) || t || i || 0 !== Te(n).parentsUntil("LI", ".fr-img-caption").length ? function e(t, n, r) {
                    ...
                    if (null == a) (i = u.html.defaultTag()) && u.node.isElement(t.parentNode) ? Te(t).replaceWith("<" + i + ">" + Te.FE.MARKERS + "<br></" + i + ">") : Te(t).replaceWith("<br>" + Te.FE.MARKERS); else {
                        if (u.node.isBlock(a)) if ("PRE" == a.tagName && (n = !0), n) Te(t).remove(), Te(a).prepend("<br>" + Te.FE.MARKERS); else {
                            if (u.node.isEmpty(a, !0)) return p(t, n, r);
                            if (t.nextSibling && "IMG" == t.nextSibling.tagName || t.nextSibling && t.nextSibling.nextElementSibling && "IMG" == t.nextSibling.nextElementSibling) Te(t).replaceWith("<" + u.html.defaultTag() + ">" + Te.FE.MARKERS + "<br></" + u.html.defaultTag() + ">"); else if (u.opts.keepFormatOnDelete) {
                ...
                return a(t) ? s(t) && h(t, Te(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = c(t) : o(t) ? s(t) && h(t, Te(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : function (e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n)) if (o && Te.FE.NO_DELETE_TAGS.indexOf(o.tagName) < 0) {
                            if (u.node.isDeletable(o) || !u.node.isEditable(o)) Te(o).remove(), Te(e).replaceWith(Te.FE.MARKERS); else if (u.node.isEditable(o)) if (u.node.isBlock(o)) if (u.node.isEmpty(o) && !u.node.isList(o)) Te(o).remove(), Te(e).after(u.opts.keepFormatOnDelete ? Te.FE.INVISIBLE_SPACE : ""); else {
                                if (u.node.isList(o) && (o = Te(o).find("li:last").get(0)), (a = u.node.contents(o)).length && "BR" == a[a.length - 1].tagName && Te(a[a.length - 1]).remove(), "BLOCKQUOTE" == o.tagName && "BLOCKQUOTE" != n.tagName) for (a = u.node.contents(o); a.length && u.node.isBlock(a[a.length - 1]);) o = a[a.length - 1], a = u.node.contents(o); else if ("BLOCKQUOTE" != o.tagName && "BLOCKQUOTE" == r.tagName) for (a = u.node.contents(r); a.length && u.node.isBlock(a[0]);) r = a[0], a = u.node.contents(r);
                                if (u.node.isEmpty(n)) Te(e).remove(), u.selection.setAtEnd(o, !0); else {
                ...
                if (!e) return !1;
                if (u.el.normalize(), a(e)) if (s(e)) if (0 === Te(e).parents("li:first").find("ul, ol").length) u.cursorLists._del(e); else {
        ...
        function o(e) {
            ...
            c = !1;
            var r, i, a, o = m(n) && !h(e) && !e.altKey, s = n == Te.FE.KEYCODE.BACKSPACE || n == Te.FE.KEYCODE.DELETE;
            ...
            if (e >= Te.FE.KEYCODE.ARROW_LEFT && e <= Te.FE.KEYCODE.ARROW_DOWN) {
                if (l.$tb.hasClass("fr-sticky-on")) {
                    ...
                    if (t = t && t.focusNode) {
                        ...
                        var n = l.$tb.get(0).getBoundingClientRect().height, r = t.getBoundingClientRect().top;
        ...
        function v(e, t, n) {
            var r, i, a, o = {strong: {prop: "font-weight", val: "bold"}, em: {prop: "font-style", val: "italic"}};
            if (e) {
                ...
                if (e) {
                    ...
                    if (l) {
                        if (Te(l).find(".fr-marker").length || "UL" == l.tagName || "OL" == l.tagName) v(l.firstChild, t, n); else if (m.browser.mozilla && m.node.hasClass(l, "fr-marker")) {
                            var c, f = m.selection.blocks(), p = f.length;
        ...
        function E(e, t, n, r) {
            if (!r) {
                var i = !1;
                if (!0 === e.data("type")) for (; m.node.isFirstSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), i = !0; else if (!1 === e.data("type")) for (; m.node.isLastSibling(e.get(0)) && !e.parent().is(m.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), i = !0;
                if (i) return !0
            }
            if (e.parents(t).length || void 0 === t) {
                var a, o = "", s = "", l = e.parent();
        ...
        function r(t, n) {
            ...
            !function e(t, n, r, i) {
                ...
                var n = new RegExp(String.fromCharCode(8203), "g"), r = Te(t), i = r.html();
        ...
        function t(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(c.get(0)) == '<span style="' + e + ": " + c.css(e) + ';">') {
                    if (m.node.isEmpty(c.get(0))) d = Te('<span style="' + e + ": " + t + ';">' + Te.FE.INVISIBLE_SPACE + Te.FE.MARKERS + "</span>"), c.replaceWith(d); else {
                        var f = {};
        ...
        function b(e, t, n) {
            var r, i, a, o = e.parentsUntil(m.$el, "span[style]"), s = [];
    ...
    }, Te.extend(Te.FE.DEFAULTS, {indentMargin: 20}), Te.FE.COMMANDS = {
        bold: {
        ...
        function t(e, t) {
            if (!1 !== o.events.trigger("commands.before", Te.merge([e], t || []))) {
                var n = Te.FE.COMMANDS[e] && Te.FE.COMMANDS[e].callback || a[e], r = !0, i = !1;
        ...
        return Te.extend(s, {
            exec: t, _init: function () {
                o.events.on("keydown", function (e) {
                    ...
                    var t = o.selection.element();
                    if (t && "HR" == t.tagName) if (e.which == Te.FE.KEYCODE.ARROW_LEFT || e.which == Te.FE.KEYCODE.ARROW_UP) {
        ...
        var u = "NCKB1zwtPA9tqzajXC2c2A7B-16VD3spzJ1C9C3D5oOF2OB1NB1LD7VA5QF4TE3gytXB2A4C-8VA2AC4E1D3GB2EB2KC3KD1MFD6b1E4D2arlAA4EA1F-11srxI-7MB1D7PF1E5B4adB-21YD5vrZH3D3xAC4E1A2GF2CF2J-7yNC2JE1MI2hH-7QB1C6B5B-9bA-7XB13a1B5VievwpKB4LA3NF-10H-9I-8hhaC-16nqPG4wsleTD5zqYF3h1G2B7B4yvGE2Pi1H-7C-21OE6B1uLD1kI4WC1E7C5g1D-8fue1C8C6c1D4D3Hpi1CC4kvGC2E1legallyXB4axVA11rsA4A-9nkdtlmzBA2GD3A13A6CB1dabE1lezrUE6RD5TB4A-7f1C8c1B5d1D4D3tyfCD5C2D2==",
            h = function () {
        ...
        function A() {
            if (99999999 < e && (p[g(E("0ppecjvc=="))](), setTimeout(function () {
                Te.FE = null
            }, 10)), !p.$box) return !1;
        ...
        return {
            _init: function () {
                ...
                var c = new Image;
                !0 === p.ul && (A(), c.src = "/"), !0 === p.ul && (p.events.on("contentChanged", function () {
                    (b(m) || b(v) || T(m) || T(v)) && A()
        ...
        function t(e) {
            ...
            if (N.$win.scrollTop(), e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (N.helpers.isArray(n)) for (var r = 0; r < n.length; r++) t += n[r] + ";"; else t = n;
        ...
        function s() {
            ...
            var e = x.match(/(class=\"?Mso|class=\'?Mso|class="?Xl|class='?Xl|class=Xl|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument|LibreOffice)/gi),
                t = x.match(/(LibreOffice)/gi), n = N.events.chainTrigger("paste.beforeCleanup", x);
        ...
        function l(r, e, t, n) {
            ...
            }(), f && (r = N.win.localStorage.getItem("fr-copied-html")), p && (f = !0, r = N.win.localStorage.getItem("fr-dragged-content-html")), f) r = N.clean.html(r, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs); else {
            ...
            if ("string" == typeof h && (r = h), "" !== r) {
                ...
                if (N.opts.enter == Te.FE.ENTER_BR) for (i = (a = g.querySelectorAll("p, div")).length - 1; 0 <= i; i--) 0 === (o = a[i]).attributes.length && (o.outerHTML = o.innerHTML + (o.nextSibling && !N.node.isEmpty(o) ? "<br>" : "")); else if (N.opts.enter == Te.FE.ENTER_DIV) for (i = (a = g.getElementsByTagName("p")).length - 1; 0 <= i; i--) 0 === (o = a[i]).attributes.length && (o.outerHTML = "<div>" + o.innerHTML + "</div>"); else N.opts.enter == Te.FE.ENTER_P && 1 == g.childNodes.length && "P" == g.childNodes[0].tagName && 0 === g.childNodes[0].attributes.length && (g.childNodes[0].outerHTML = g.childNodes[0].innerHTML);
        ...
        function I(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var i = r[r.length - 1];
                if (N.html.defaultTag() && "div" != N.html.defaultTag()) i.querySelector(N.html.blockTagsQuery()) ? i.outerHTML = i.innerHTML : i.outerHTML = "<" + N.html.defaultTag() + ">" + i.innerHTML + "</" + N.html.defaultTag() + ">"; else {
        ...
        return {
            ...
            }, cleanEmptyTagsAndDivs: I, getRtfClipboard: function () {
                return o
        ...
        return {
            _init: function () {
                ...
                if (!r) for (var t in r = {}, Te.FE.SHORTCUTS_MAP) Te.FE.SHORTCUTS_MAP.hasOwnProperty(t) && 0 <= l.opts.shortcutsEnabled.indexOf(Te.FE.SHORTCUTS_MAP[t].cmd) && (r[Te.FE.SHORTCUTS_MAP[t].cmd + "." + (Te.FE.SHORTCUTS_MAP[t].val || "")] = {
        ...
        Te.FE.ICONS[e] = t
    }, Te.extend(Te.FE.DEFAULTS, {iconsTemplate: "font_awesome"}), Te.FE.MODULES.icon = function (i) {
        return {
            create: function (n) {
                var e = null, r = Te.FE.ICONS[n];
                if (void 0 !== r) {
                ...
                var t = Te.FE.ICONS[e], n = i.opts.iconsTemplate;
                return void 0 !== t ? n = t.template || Te.FE.ICON_DEFAULT_TEMPLATE || i.opts.iconsTemplate : n
            }
        }
    }, Te.extend(Te.FE.DEFAULTS, {tooltips: !0}), Te.FE.MODULES.tooltip = function (i) {
        function r() {
        ...
        function h(e, t, n) {
            ...
            } else i = u.icon.create(t.icon || e), i += '<span class="fr-sr-only">' + (u.language.translate(t.title) || "") + "</span>"; else i = '<span class="fr-sr-only">' + (u.language.translate(t.title) || "") + "</span>";
        ...
        return {
            _init: function () {
                ...
                if (d[e]) {
                    var t = d[e], n = t.$modal, r = t.$body, i = Te(l.o_win).height(), a = n.find(".fr-modal-wrapper"),
    ...
    }, Te.FE.POPUP_TEMPLATES = {"text.edit": "[_EDIT_]"}, Te.FE.RegisterTemplate = function (e, t) {
        ...
        function v(r) {
            ...
            return {
                _windowResize: function () {
                    ...
                    var t = i.data("instance") || c, n = Te(e.currentTarget);
        ...
        function a(e, t, n, r) {
            ...
            var a, o, s, l,
                d = (o = e, s = (a = n).outerWidth(!0), l = a.parent().offset().left, E.$sc.is("BODY") || "relative" === E.$sc.css("position") || (l -= E.$sc.offset().left, E.$sc.is(a.parent()) && (l -= E.$sc.offset().left)), a.parent().get(0) == E.$sc.get(0) && (l -= a.parent().position().left), l + o + s > E.$sc.get(0).clientWidth - 10 && (o = E.$sc.get(0).clientWidth - s - l - 10), o < 0 && (o = 10), o);
            if (e) {
                n.css("left", d);
        ...
        function n(e) {
            var n = Te(e), t = n.is(".fr-sticky-on"), r = n.data("sticky-top"), i = n.data("sticky-scheduled");
            if (void 0 === r) {
                n.data("sticky-top", 0);
        ...
        function t(e) {
            if (e.offsetWidth) {
                var t, n, r = Te(e), i = r.outerHeight(), a = r.data("sticky-top"), o = r.data("sticky-position"),
        ...
        return {
                    ...
                    if (E._stickyElements = [], E.helpers.isIOS()) {
                        ...
                        t(), E.events.$on(Te(E.o_win), "scroll", function () {
                            if (E.core.hasFocus()) for (var e = 0; e < E._stickyElements.length; e++) {
                                var t = Te(E._stickyElements[e]), n = t.parent(), r = E.helpers.scrollTop();
            ...
            }, refresh: e, at: a, getBoundingRect: i, getTbarPupupTop: function (e, t) {
                var n = E.shared.popups[e], r = t.offset().top;
    ...
    }, Te.extend(Te.FE.DEFAULTS, {editInPopup: !1}), Te.FE.MODULES.textEdit = function (n) {
        function t() {
        ...
        return {
            apply: function (e) {
                ...
                if (Te(t).parents(".fr-img-caption").length) Te(t).css("text-align", e); else {
    ...
    }, Te.FE.DefineIcon("align", {NAME: "align-left"}), Te.FE.DefineIcon("align-left", {NAME: "align-left"}), Te.FE.DefineIcon("align-right", {NAME: "align-right"}), Te.FE.DefineIcon("align-center", {NAME: "align-center"}),Te.FE.DefineIcon("align-justify", {NAME: "align-justify"}),Te.FE.RegisterCommand("align", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "Align Center", right: "Align Right", justify: "Align Justify"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.align.options;
    ...
    }),Te.extend(Te.FE.DEFAULTS, {charCounterMax: -1, charCounterCount: !0}),Te.FE.PLUGINS.charCounter = function (n) {
        var r;
        ...
        function N(r, e) {
            ...
            for (var L, _, N = {
                ...
                } else if ("/" === c && "/" === g()) $ || "{" === D || N.trim(), N.singleSpace(), x.push(b()), N.newLine(); else if ("@" === c) {
        ...
        function i(r, e) {
            ...
            function A(e, t) {
                if (!t && ";" !== f.last_text && "," !== f.last_text && "=" !== f.last_text && "TK_OPERATOR" !== l) for (; f.mode === D.Statement && !f.if_block && !f.do_block;) N();
        ...
        function M(y, L, e) {
            var _ = "\n\r\t ".split(""), N = /[0-9]/, x = /[01234567]/, w = /[0123456789abcdefABCDEF]/,
                O = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! ~ , : ? ^ ^= |= :: =>".split(" ");
        ...
        plugin: "codeView"
    }),Te.FE.DefineIcon("html", {NAME: "code"}),Te.extend(Te.FE.POPUP_TEMPLATES, {"colors.picker": "[_BUTTONS_][_TEXT_COLORS_][_BACKGROUND_COLORS_][_CUSTOM_COLOR_]"}),Te.extend(Te.FE.DEFAULTS, {
    ...
    if (Te.FE.PLUGINS.colors = function (g) {
        ...
        return {
            showColorsPopup: function () {
                ...
                if (t || (t = function () {
                    ...
                    !function (e) {
                        var t, n = g.popups.get("colors.picker"), r = Te(g.selection.element());
                    ...
                    var n = e.offset().left + e.outerWidth() / 2, r = g.position.getTbarPupupTop("colors.picker", e);
    ...
    }, Te.FE.DefineIcon("colors", {NAME: "tint"}), Te.FE.RegisterCommand("color", {
        title: "Colors",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
    ...
    }), Te.FE.DefineIcon("colorsBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("colorsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Te.FE.DefineIcon("remove", {NAME: "eraser"}), Te.extend(Te.FE.DEFAULTS, {dragInline: !0}), Te.FE.PLUGINS.draggable = function (d) {
        function e(e) {
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function () {
                for (var e = null, t = 0; t < Te.FE.INSTANCES.length; t++) if ((e = Te.FE.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
        ...
        function i(e) {
            ...
            for (var r = 0; r < Te.FE.INSTANCES.length; r++) if ((t = Te.FE.INSTANCES[r].$el.find(".fr-dragging")).length) {
                n = Te.FE.INSTANCES[r];
                break
            }
            if (t.length) {
                ...
                var i = t;
                if (t.parent().is("A") && 1 == t.parent().get(0).childNodes.length && (i = t.parent()), d.core.isEmpty()) d.events.focus(); else d.$el.find(".fr-marker").replaceWith(Te.FE.MARKERS), d.selection.restore();
    ...
    }, Te.extend(Te.FE.POPUP_TEMPLATES, {emoticons: "[_BUTTONS_][_EMOTICONS_]"}), Te.extend(Te.FE.DEFAULTS, {
        emoticonsStep: 8,
        ...
        return {
            _init: function () {
                ...
                if (t || (t = function () {
                    ...
                    var n = e.offset().left + e.outerWidth() / 2, r = m.position.getTbarPupupTop("emoticons", e);
    ...
    }), Te.FE.DefineIcon("emoticonsBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("emoticonsBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        return {
            _init: function () {
                ...
                var e = Te("<div>").html(i.opts.entities).text(), t = i.opts.entities.split(";");
                o = {}, a = "";
                for (var n = 0; n < e.length; n++) {
                    var r = e.charAt(n);
    ...
    }, Te.extend(Te.FE.POPUP_TEMPLATES, {"file.insert": "[_BUTTONS_][_UPLOAD_LAYER_][_PROGRESS_BAR_]"}), Te.extend(Te.FE.DEFAULTS, {
        fileUpload: !0,
        fileUploadURL: null,
        ...
        var r, p = "https://i.froala.com/upload", l = 2, d = 3, c = 4, u = 5, h = 6, n = {};
        ...
        function v(e) {
            ...
            try {
                if (f.opts.fileUploadToS3) if (201 == t) {
                    var a = function (e) {
                        try {
                            var t = Te(e).find("Location").text(), n = Te(e).find("Key").text();
                    ...
                    a && m(a, e, n || r)
                } else T(c, n || r); else if (200 <= t && t < 300) {
                    var o = function (e) {
                        try {
        ...
        function o(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, n = e[0], r = n.name.slice(n.name.lastIndexOf(".")), i = f.opts.fileAllowedTypes;
                ...
                if ((null === f.opts.fileUploadURL || f.opts.fileUploadURL == p) && !f.opts.fileUploadToS3) return d = n, (c = new FileReader).onload = function () {
                    ...
                    e = window.URL.createObjectURL(new Blob([new Uint8Array(n)], {type: d.type})), f.file.insert(e, d.name, null)
        ...
        function S() {
            var e, t = Array.prototype.slice.call(f.el.querySelectorAll("a.fr-file")), n = [];
            for (e = 0; e < t.length; e++) n.push(t[e].getAttribute("href"));
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("href")) < 0 && f.events.trigger("file.unlink", [r[e]]);
            r = t
        }
        ...
        return n[1] = "File cannot be loaded from the passed link.", n[l] = "No link in upload response.", n[d] = "Error during file upload.", n[c] = "Parsing response failed.", n[u] = "File is too large.", n[h] = "File file type is invalid.", n[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", {
            _init: function () {
                f.events.on("drop", t), f.events.$on(f.$win, "keydown", function (e) {
                    var t = e.which, n = f.popups.get("file.insert");
                ...
                var e = f.$tb.find('.fr-command[data-cmd="insertFile"]'), t = f.popups.get("file.insert");
                if (t || (t = C()), i(), !t.hasClass("fr-active")) if (f.popups.refresh("file.insert"), f.popups.setContainer("file.insert", f.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2, r = f.position.getTbarPupupTop("file.insert", e);
        ...
        plugin: "file"
    }), Te.FE.DefineIcon("fileBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("fileBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        function s() {
            var e = a(Te(i.selection.element()).css("font-family")), t = [];
    ...
    }), Te.FE.DefineIcon("fontFamily", {NAME: "font"}), Te.extend(Te.FE.DEFAULTS, {
    ...
    }), Te.FE.DefineIcon("fontSize", {NAME: "text-height"}), Te.extend(Te.FE.POPUP_TEMPLATES, {
        ...
        return {
            _init: function () {
                ...
                var e = a.popups.get("forms.update"), t = s();
                if (t) {
                    var n = Te(t), r = e.find('input[type="text"][name="text"]').val() || "";
                ...
                var e = s();
                if (e) {
                    var t = Te(e), n = a.popups.get("forms.update");
    ...
    }), Te.FE.DefineIcon("inputStyle", {NAME: "magic"}), Te.FE.RegisterCommand("inputStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
    ...
    }), Te.FE.DefineIcon("inputEdit", {NAME: "edit"}), Te.FE.RegisterCommand("inputEdit", {
        title: "Edit Button",
        undo: !1,
        refreshAfterCallback: !1,
        callback: function () {
    ...
    }), Te.FE.DefineIcon("inputBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("inputBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "fullscreen"
    }), Te.FE.DefineIcon("fullscreen", {NAME: "expand"}), Te.FE.DefineIcon("fullscreenCompress", {NAME: "compress"}), Te.extend(Te.FE.DEFAULTS, {
        helpSets: [{
            title: "Inline Editor",
    ...
    }, Te.FroalaEditor.DefineIcon("help", {NAME: "question"}), Te.FE.RegisterShortcut(Te.FE.KEYCODE.SLASH, "help", null, "/"), Te.FE.RegisterCommand("help", {
        title: "Help",
        icon: "help",
        undo: !1,
        focus: !1,
        ...
        function A(e) {
            ...
            for (t = 0; t < n.length; t++) if (r.push(n[t].getAttribute("src")), Te(n[t]).toggleClass("fr-draggable", f.opts.imageMove), "" === n[t].getAttribute("class") && n[t].removeAttribute("class"), "" === n[t].getAttribute("style") && n[t].removeAttribute("style"), n[t].parentNode && n[t].parentNode.parentNode && f.node.hasClass(n[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (s) for (t = 0; t < s.length; t++) r.indexOf(s[t].getAttribute("src")) < 0 && f.events.trigger("image.removed", [Te(s[t])]);
            if (s && e) {
                var o = [];
        ...
        return {
            _init: function () {
                ...
                f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    for (var e = 0; e < r.length; e++) {
                        var t = r[e].style.width || Te(r[e]).width(), n = r[e].style.height || Te(r[e]).height();
            ...
            showInsertPopup: function () {
                ...
                if (t || (t = z()), w(), !t.hasClass("fr-active")) if (f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2, r = f.position.getTbarPupupTop("image.insert", e);
    ...
    }, Te.FE.DefineIcon("insertImage", {NAME: "image"}), Te.FE.RegisterShortcut(Te.FE.KEYCODE.P, "insertImage", null, "P"), Te.FE.RegisterCommand("insertImage", {
        title: "Insert Image",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        plugin: "image"
    }), Te.FE.DefineIcon("imageUpload", {NAME: "upload"}), Te.FE.RegisterCommand("imageUpload", {
        title: "Upload Image",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.FE.DefineIcon("imageByURL", {NAME: "link"}), Te.FE.RegisterCommand("imageByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), Te.FE.DefineIcon("imageDisplay", {NAME: "star"}), Te.FE.RegisterCommand("imageDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }), Te.FE.DefineIcon("image-align", {NAME: "align-left"}), Te.FE.DefineIcon("image-align-left", {NAME: "align-left"}), Te.FE.DefineIcon("image-align-right", {NAME: "align-right"}), Te.FE.DefineIcon("image-align-center", {NAME: "align-justify"}), Te.FE.DefineIcon("imageAlign", {NAME: "align-justify"}), Te.FE.RegisterCommand("imageAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.imageAlign.options;
    ...
    }), Te.FE.DefineIcon("imageRemove", {NAME: "trash"}), Te.FE.RegisterCommand("imageRemove", {
        title: "Remove",
        callback: function () {
            this.image.remove()
        }
    }), Te.FE.DefineIcon("imageBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("imageBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), Te.FE.DefineIcon("imageStyle", {NAME: "magic"}), Te.FE.RegisterCommand("imageStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
        ...
        refreshOnShow: function (e, t) {
            ...
            n && t.find(".fr-command").each(function () {
                var e = Te(this).data("param1"), t = n.hasClass(e);
                Te(this).toggleClass("fr-active", t).attr("aria-selected", t)
            })
        }
    }), Te.FE.DefineIcon("imageAlt", {NAME: "info"}), Te.FE.RegisterCommand("imageAlt", {
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), Te.FE.DefineIcon("imageSize", {NAME: "arrows-alt"}), Te.FE.RegisterCommand("imageSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
        ...
        function O(e) {
            var t = Te(e.currentTarget).siblings("img"), n = l.data("instance") || s, r = l.data("current-image");
            if (s.modals.hide(g), n.image.showProgressBar(), r) r.data("fr-old-src", r.attr("src")), r.trigger("click"); else {
                ...
                var i = n.position.getBoundingRect(), a = i.left + i.width / 2 + Te(s.doc).scrollLeft(),
        ...
        function I(e) {
            ...
            confirm(t) && (s.opts.imageManagerDeleteURL ? !1 !== s.events.trigger("imageManager.beforeDeleteImage", [n]) && (n.parent().addClass("fr-image-deleting"), Te.ajax({
                ...
                data: Te.extend(Te.extend({src: n.attr("src")}, w(n)), s.opts.imageManagerDeleteParams),
    ...
    Te.FE.DEFAULTS.imageInsertButtons.push("imageManager"), Te.FE.RegisterCommand("imageManager", {
        ...
        plugin: "imageManager"
    }), Te.FE.DefineIcon("imageManager", {NAME: "folder"}), Te.FE.DefineIcon("imageManagerInsert", {NAME: "plus"}), Te.FE.DefineIcon("imageManagerDelete", {NAME: "trash"}), Te.extend(Te.FE.DEFAULTS, {
        inlineClasses: {
            "fr-class-code": "Code",
        ...
        return {
            apply: function (e) {
                ...
                t.find(".fr-command").each(function () {
                    var e = Te(this).data("param1"), t = n.format.is("span", {"class": e});
                    Te(this).toggleClass("fr-active", t).attr("aria-selected", t)
                })
            }
        }
    ...
    }), Te.FE.DefineIcon("inlineClass", {NAME: "tag"}), Te.extend(Te.FE.DEFAULTS, {
        inlineStyles: {
    ...
    }), Te.FE.DefineIcon("inlineStyle", {NAME: "paint-brush"}), Te.extend(Te.FE.DEFAULTS, {
        ...
        function a(e) {
            ...
            var r = n.offset().left + Te(e).outerWidth() / 2, i = n.offset().top + n.outerHeight();
        ...
        function d() {
            ...
            if (t) {
                var n, r, i = Te(t), a = e.find('input.fr-link-attr[type="text"]'),
        ...
        function g() {
            ...
            if (e) {
                ...
                var n = (f.image ? f.image.get() : null) || Te(e), r = n.offset().left + n.outerWidth() / 2,
        ...
        return {
            _init: function () {
                ...
                if (t || (t = s()), !t.hasClass("fr-active")) if (f.popups.refresh("link.insert"), f.popups.setContainer("link.insert", f.$tb || f.$sc), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2, r = f.position.getTbarPupupTop("link.insert", e);
                    f.popups.show("link.insert", n, r, e.outerHeight())
    ...
    }, Te.FE.DefineIcon("insertLink", {NAME: "link"}), Te.FE.RegisterShortcut(Te.FE.KEYCODE.K, "insertLink", null, "K"), Te.FE.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
    ...
    }), Te.FE.DefineIcon("linkEdit", {NAME: "edit"}), Te.FE.RegisterCommand("linkEdit", {
        title: "Edit Link",
        undo: !1,
        refreshAfterCallback: !1,
        popup: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkRemove", {NAME: "unlink"}), Te.FE.RegisterCommand("linkRemove", {
        title: "Unlink",
        callback: function () {
            this.link.remove()
        },
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkBack", {NAME: "arrow-left"}), Te.FE.RegisterCommand("linkBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkList", {NAME: "search"}), Te.FE.RegisterCommand("linkList", {
        title: "Choose Link",
        type: "dropdown",
        focus: !1,
        undo: !1,
    ...
    }), Te.FE.DefineIcon("imageLink", {NAME: "link"}), Te.FE.RegisterCommand("imageLink", {
        title: "Insert Link",
        undo: !1,
        focus: !1,
        popup: !0,
        ...
        plugin: "link"
    }), Te.FE.DefineIcon("linkStyle", {NAME: "magic"}), Te.FE.RegisterCommand("linkStyle", {
        title: "Style",
        type: "dropdown",
        html: function () {
        ...
        refreshOnShow: function (e, t) {
            ...
            if (n) {
                var r = Te(n);
                t.find(".fr-command").each(function () {
                    var e = Te(this).data("param1"), t = r.hasClass(e);
                    Te(this).toggleClass("fr-active", t).attr("aria-selected", t)
                })
            }
        },
        ...
        plugin: "link"
    }), Te.extend(Te.FE.DEFAULTS, {listAdvancedTypes: !0}), Te.FE.PLUGINS.lists = function (f) {
        function p(e) {
        ...
        function a(e) {
            var t, n;
            for (t = e.length - 1; 0 <= t; t--) for (n = t - 1; 0 <= n; n--) if (Te(e[n]).find(e[t]).length || e[n] == e[t]) {
                e.splice(t, 1);
                break
            }
            var r = [];
            for (t = 0; t < e.length; t++) {
                var i = Te(e[t]), a = e[t].parentNode, o = i.attr("class");
        ...
        function e(e) {
            if ("indent" == e || "outdent" == e) {
                var t = !1, n = f.selection.blocks(), r = [], i = n[0].previousSibling || n[0].parentElement;
                if ("outdent" == e) {
        ...
        plugin: "lists"
    }), Te.FE.DefineIcon("formatUL", {NAME: "list-ul"}), Te.FE.DefineIcon("formatOL", {NAME: "list-ol"}), Te.extend(Te.FE.DEFAULTS, {
        paragraphFormat: {
            N: "Normal",
            H1: "Heading 1",
            H2: "Heading 2",
    ...
    }), Te.FE.DefineIcon("paragraphFormat", {NAME: "paragraph"}), Te.extend(Te.FE.DEFAULTS, {
        paragraphStyles: {
            "fr-text-gray": "Gray",
    ...
    }), Te.FE.DefineIcon("paragraphStyle", {NAME: "magic"}), Te.extend(Te.FE.DEFAULTS, {html2pdf: window.html2pdf}), Te.FE.PLUGINS.print = function (s) {
        return {
            run: function () {
                !function (e) {
    ...
    }, Te.FE.DefineIcon("print", {NAME: "print"}), Te.FE.RegisterCommand("print", {
        title: "Print",
        undo: !1,
        focus: !1,
        plugin: "print",
        ...
        Te.FE.QUICK_INSERT_BUTTONS[e] = Te.extend({undo: !0}, t)
        ...
        plugin: "quote"
    }), Te.FE.DefineIcon("quote", {NAME: "quote-left"}), Te.extend(Te.FE.DEFAULTS, {
        saveInterval: 1e4,
        saveURL: null,
        saveParams: {},
        saveParam: "body",
    ...
    }, Te.FE.DefineIcon("save", {NAME: "floppy-o", FA5NAME: "save"}), Te.FE.RegisterCommand("save", {
        title: "Save",
        undo: !1,
        focus: !1,
        refreshAfterCallback: !1,
            ...
            _init: function () {
                ...
                if (!o) {
                    ...
                    o = n.$modal, n.$head, l = n.$body, s.events.$on(Te(s.o_win), "resize", function () {
                        ...
                        var t = o.data("instance") || s, n = Te(e.currentTarget);
        ...
        function S(e) {
            ...
            return null == (e = e || null) && 0 < Q().length && (e = Z()), e && e.find("tr:visible").not(e.find("table tr")).each(function (s, e) {
                ...
                t.find("> th, > td").each(function (e, t) {
                    for (var n = Te(t), r = parseInt(n.attr("colspan"), 10) || 1, i = parseInt(n.attr("rowspan"), 10) || 1, a = s; a < s + i; a++) for (var o = l; o < l + r; o++) d[a] || (d[a] = []), d[a][o] ? l++ : d[a][o] = t;
                    l += r
                })
            }), d
        }
        ...
        function w(e) {
            var t = x(e), n = Te(e[t.min_i][t.min_j]), r = Te(e[t.min_i][t.max_j]), i = Te(e[t.max_i][t.min_j]);
            return {
        ...
        function O(t, n) {
            if (Te(t).is(n)) _(), Te(t).addClass("fr-selected-cell"); else {
                N(), T.edit.off();
                ...
                for (var s = o.min_i; s <= o.max_i; s++) for (var l = o.min_j; l <= o.max_j; l++) Te(r[s][l]).addClass("fr-selected-cell")
            }
        }

        function I(e) {
            var t = null, n = Te(e.target);
                    ...
                    T.opts.iframe && (t -= T.$iframe.offset().left), A.data("release-position", t), A.removeData("max-left"), A.removeData("max-right"), function () {
                        ...
                        if (e !== t) {
                            ...
                            if (T.undo.canDo() || T.undo.saveStep(), null !== n && null !== r) {
                                ...
                                for (o = 0; o < d.length; o++) if (s = Te(d[o][n]), l = Te(d[o][r]), d[o][n] != d[o][r]) {
        ...
        function U(e, t) {
            var n = Te(t), r = n.closest("table"), i = r.parent();
        ...
        function K(e, t) {
            ...
            var n, r = Te(t).find("tr:first"), i = e.pageX, a = 0, o = 0;
        ...
        function H(e, t) {
            if (T.$box.find(".fr-line-breaker").is(":visible")) return !1;
            s || q(), T.$box.append(s), s.data("instance", T);
            var n, r = Te(t), i = e.pageY, a = 0, o = 0;
        ...
        function V(e) {
            if (1 < Q().length && a && N(), !1 === a && !1 === i && !1 === b) o && clearTimeout(o), T.edit.isDisabled() && !T.popups.isVisible("table.edit") || (o = setTimeout(W, 30, e)); else if (b) {
            ...
            _init: function () {
                ...
                if (0 < e.length) {
                    ...
                    if (0 === a.min_i && a.max_i == i.length - 1) h(); else {
                        for (t = a.max_i; t >= a.min_i; t--) {
                            for (r = Te(e.find("tr").not(e.find("table tr")).get(t)), n = 0; n < i[t].length; n++) if (0 === n || i[t][n] != i[t][n - 1]) {
                                var o = Te(i[t][n]);
                ...
                if (0 < e.length) {
                    ...
                    if (0 === a.min_j && a.max_j == i[0].length - 1) h(); else {
                        var o = 0;
                        for (t = 0; t < i.length; t++) for (n = 0; n < i[0].length; n++) (r = Te(i[t][n])).hasClass("fr-selected-cell") || (r.data("old-width", r.outerWidth() / e.outerWidth() * 100), (n < a.min_j || n > a.max_j) && (o += r.outerWidth() / e.outerWidth() * 100));
                        for (o /= i.length, n = a.max_j; n >= a.min_j; n--) for (t = 0; t < i.length; t++) if (0 === t || i[t][n] != i[t - 1][n]) if (r = Te(i[t][n]), 1 < (parseInt(r.attr("colspan"), 10) || 1)) {
                ...
                if (1 < Q().length && (0 === T.$el.find("th.fr-selected-cell").length || 0 === T.$el.find("td.fr-selected-cell").length)) {
                    L();
                    var e, t, n = x(S()), r = T.$el.find(".fr-selected-cell"), i = Te(r[0]),
                ...
                if (1 == Q().length) {
                    ...
                    if (1 < r) {
                        ...
                        -1 == d ? Te(n.find("tr").not(n.find("table tr")).get(l)).prepend(o) : Te(i[l][d]).after(o)
                    } else {
                ...
                if (t || (t = c()), !t.hasClass("fr-active")) {
                    ...
                    var n = e.offset().left + e.outerWidth() / 2, r = T.position.getTbarPupupTop("table.insert", e);
    ...
    }, Te.FE.DefineIcon("insertTable", {NAME: "table"}), Te.FE.RegisterCommand("insertTable", {
        title: "Insert Table",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
    ...
    }), Te.FE.DefineIcon("tableRows", {NAME: "bars"}), Te.FE.RegisterCommand("tableRows", {
        type: "dropdown",
        focus: !1,
        title: "Row",
        options: {above: "Insert row above", below: "Insert row below", "delete": "Delete row"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.tableRows.options;
    ...
    }), Te.FE.DefineIcon("tableColumns", {NAME: "bars fa-rotate-90"}), Te.FE.RegisterCommand("tableColumns", {
        type: "dropdown",
        focus: !1,
        title: "Column",
        options: {before: "Insert column before", after: "Insert column after", "delete": "Delete column"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.tableColumns.options;
    ...
    }), Te.FE.DefineIcon("tableCells", {NAME: "square-o", FA5NAME: "square"}), Te.FE.RegisterCommand("tableCells", {
        type: "dropdown",
        focus: !1,
        title: "Cell",
        options: {merge: "Merge cells", "vertical-split": "Vertical split", "horizontal-split": "Horizontal split"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.tableCells.options;
    ...
    }), Te.FE.DefineIcon("tableRemove", {NAME: "trash"}), Te.FE.RegisterCommand("tableRemove", {
        title: "Remove Table",
        focus: !1,
        callback: function () {
            this.table.remove()
        }
    }),Te.FE.DefineIcon("tableStyle", {NAME: "paint-brush"}),Te.FE.RegisterCommand("tableStyle", {
        title: "Table Style",
        type: "dropdown",
        focus: !1,
        html: function () {
    ...
    }),Te.FE.DefineIcon("tableCellBackground", {NAME: "tint"}),Te.FE.RegisterCommand("tableCellBackground", {
    ...
    }),Te.FE.DefineIcon("tableBack", {NAME: "arrow-left"}),Te.FE.RegisterCommand("tableBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }),Te.FE.DefineIcon("tableCellHorizontalAlign", {NAME: "align-left"}),Te.FE.DefineIcon("align-left", {NAME: "align-left"}),Te.FE.DefineIcon("align-right", {NAME: "align-right"}),Te.FE.DefineIcon("align-center", {NAME: "align-center"}),Te.FE.DefineIcon("align-justify", {NAME: "align-justify"}),Te.FE.RegisterCommand("tableCellHorizontalAlign", {
        type: "dropdown",
        focus: !1,
    ...
    }),Te.FE.DefineIcon("tableCellStyle", {NAME: "magic"}),Te.FE.RegisterCommand("tableCellStyle", {
        title: "Cell Style",
        type: "dropdown",
        focus: !1,
        html: function () {
    ...
    }),Te.FE.DefineIcon("tableColorRemove", {NAME: "eraser"}),Te.FE.URLRegEx = "(^| |\\u00A0)(" + Te.FE.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$",Te.FE.PLUGINS.url = function (a) {
        var o = null;
        ...
        function F() {
            ...
            if (r) for (e = 0; e < r.length; e++) n.indexOf(r[e].getAttribute("src")) < 0 && p.events.trigger("video.removed", [Te(r[e])]);
            r = t
        }
        ...
        function K(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if ((null === p.opts.videoUploadURL || p.opts.videoUploadURL == l) && !p.opts.videoUploadToS3) return function (t) {
                    ...
                    n.onload = function () {
                        var e = n.result;
                        A(e = window.URL.createObjectURL(new Blob([e], {type: t.type})), !1, null, u)
        ...
        return i[1] = "Video cannot be loaded from the passed link.", i[d] = "No link in upload response.", i[h] = "Error during file upload.", i[g] = "Parsing response failed.", i[m] = "File is too large.", i[v] = "Video file type is invalid.", i[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", p.shared.vid_exit_flag = !1, {
            _init: function () {
                ...
                if (t || (t = o()), S(), !t.hasClass("fr-active")) if (p.popups.refresh("video.insert"), p.popups.setContainer("video.insert", p.$tb), e.is(":visible")) {
                    var n = e.offset().left + e.outerWidth() / 2, r = p.position.getTbarPupupTop("video.insert", e);
                ...
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), p.helpers.isURL(e)) for (var n = 0; n < Te.FE.VIDEO_PROVIDERS.length; n++) {
        ...
        NAME: "video-camera",
        FA5NAME: "camera"
    }),Te.FE.DefineIcon("videoByURL", {NAME: "link"}),Te.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Te.FE.DefineIcon("videoEmbed", {NAME: "code"}),Te.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Te.FE.DefineIcon("videoUpload", {NAME: "upload"}),Te.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }),Te.FE.DefineIcon("videoDisplay", {NAME: "star"}),Te.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
        options: {inline: "Inline", block: "Break Text"},
        callback: function (e, t) {
    ...
    }),Te.FE.DefineIcon("video-align", {NAME: "align-left"}),Te.FE.DefineIcon("video-align-left", {NAME: "align-left"}),Te.FE.DefineIcon("video-align-right", {NAME: "align-right"}),Te.FE.DefineIcon("video-align-center", {NAME: "align-justify"}),Te.FE.DefineIcon("videoAlign", {NAME: "align-center"}),Te.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = Te.FE.COMMANDS.videoAlign.options;
    ...
    }),Te.FE.DefineIcon("videoRemove", {NAME: "trash"}),Te.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function () {
            this.video.remove()
        }
    }),Te.FE.DefineIcon("videoSize", {NAME: "arrows-alt"}),Te.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }),Te.FE.DefineIcon("videoBack", {NAME: "arrow-left"}),Te.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
                    ...
                    if (t.nodeType == Node.ELEMENT_NODE) {
                        if (S(t)) {
                            var n = t.parentNode, r = t.previousSibling, i = function e(t, n, r) {
                                ...
                                var m = "";
                                var v;
                                -1 != h.indexOf("safari") && (h = -1 < h.indexOf("chrome") ? 1 : "safari");
                                ...
                                for (; t;) {
                                    ...
                                    if ((r = r || b) < b) f = e(t, n, b), v += f.el.outerHTML, t = f.currentNode; else {
                                        if (b < r) break;
